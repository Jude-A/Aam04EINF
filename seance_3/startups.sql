...
('Hooli', 'Silicon Valley', 'Entreprise', 9000, 580000000, 49500000000 ,1997, , 'Gavin Bensen', 'Hooli est une affaire de personnes'),
('Raviga Capital', 'Silicon Valley', 'Venture Capital', 12, 3000000000, ,2012, , 'Peter Gregory', 'Share Only In Success'),
('Aviato', 'Silicon Valley', 'Voyage', 3, 250000, 2500000, 2006, 'A', 'Erlich Bachman', 'Software Aggregation Program'),
('SEE FOOD', 'Silicon Valley', 'Mobile', 2, , 15000000, 2016, 'A', 'Jian-Yang',  'The Shazam of Food'),
...
('E-Corp', 'New York', 'Entreprise',  10000,    66000000000,, 2006, , 'Phillip Price',  'Together We Can Change the World'),
('Allsafe Cybersecurity', 'New York', 'Securité', 250,   123000000,  1000000000,  2014,, 'Gideon Goddard',),
('fsociety', 'Brooklyn', 'Jeux', 5,  ,,  2015,  'S',  'Elliot Alderson',  'Fun Society Arcade'),
('Summit Ice',  'Los Angeles', 'Mode',  2,  50000, 800000,   2015,  'Jeune pousse', 'Nathan Fielder', 'Raising Awareness of the Holocaust'),
('The Movement',   'Los Angeles', 'Fitness',  3,  15000,  ,  2015 , 'Jeune pousse',  'Nathan Fielder', 'No Gym. No Weights. Just Results.'),
('WUPHF!',  'Scranton', 'Social',   6,  25000, 10000, 2010,  'Jeune pousse',  'Ryan Howard', 'Cross-Portal Messaging System'),
('Fakeblock',   'Irvine',   'Mobile',   2,  3,  ,  2013,  'Jeune pousse',  'George Michael', 'OC\'s Most Popular Digital Wood Instrument'),
...
('Everyotherday.me',  'San Francisco', 'Mobile',   35, , , 2012,  'Jeune pousse',  'Jeremy Lin',  'Journal that Captures the Special Moments'),
('Frontsby', 'San Francisco',,,,, 2013,  'Jeune pousse',  'Olivia Plath',),  
('2Smart2Host', 'Brooklyn', 'Big Data', 4,  380000,   ,   2014, 'A', 'Evan Nails', 'Dynamic Pricing for Vacation Rentals'),
...
('Cluster.ly',  'New York',  'Big Data',   10, 750000,   15000000, 2015,  'B',  'Hillary Limegreen',), 
...
('nova.ai',  'Palo Alto',  'Entreprise',  340,   3000000,  25000000, 2013,  'A',  'Nick Kinsella',),  
...
('Townie666',   'Brooklyn',    2,  ,20000, 80000, 2017,  'Jeune pousse',  'Sonny Li', '*_*'),
('Kimberly', 'Brooklyn',    2,  100000,   ,8500000,  2018,  'Jeune pousse',  'Jillian Kuzmin', 'Synthetic Diamonds'),
('Wakeful',  'Brooklyn', 'Réalité Augmenté',  3,  30000, 1800000,  2016,  'Jeune pousse',  'Maria Epstein',  'Meditation VR App'),
('MLGB',  'Columbus', 'E-commerce',  2,  50000, 500000,   2012,  'Jeune pousse',  'Xin Xin',  'Authentic Streetwear or DDoS\'ed'),
('PostGurt', 'Savannah', 'Social',   6,  550000,   200000000,   2013,  'Jeune pousse',  'Lauretta Brieman',  'Subscription Based Yogurt in the Mail'),
('Virtual Tour',   'Chicago',  'E-commerce',  12, 750000,   120000000,   2014 , 'Jeune pousse',  'Ari L\'Boy',   'Real Estate for Fake People');